import{_ as C}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-BilWcdN8.js";import{C as e}from"./CodeBlock-BcGcsIUU.js";import{O as i}from"./OutputBlock-CdA9ge79.js";import{d as I,r,p as k,l as E,a as l,t as O,e as s,k as n,o as T}from"./index-BbkNKk44.js";import"./Footer.vue_vue_type_script_setup_true_lang-Ru-ZxfwF.js";const U={class:"text-gray-500 mb-2 text-lg"},w={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},D={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},F={class:"text-gray-500 mb-2 text-lg"},M="March 30, 2026",j=I({__name:"ArrayIntroductionIndex",setup(P){const a=r(`
int c = 2;
int u = 4;
int t = 8;
int e = 16;
