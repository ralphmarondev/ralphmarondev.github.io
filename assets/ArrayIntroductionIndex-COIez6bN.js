import{_ as C}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-T_F0xssW.js";import{C as e}from"./CodeBlock-BawFMjar.js";import{O as i}from"./OutputBlock-X97pfRco.js";import{d as I,r,s as E,j as k,a as l,t as O,e as s,h as n,o as T}from"./index-V7ZTurBu.js";import"./Footer.vue_vue_type_script_setup_true_lang-X364togL.js";const U={class:"text-gray-500 mb-2 text-lg"},w={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},D={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},F={class:"text-gray-500 mb-2 text-lg"},M="March 30, 2026",$=I({__name:"ArrayIntroductionIndex",setup(P){const a=r(`
int c = 2;
int u = 4;
int t = 8;
int e = 16;
