import{_ as f}from"./MainLayout.vue_vue_type_style_index_0_lang-BFtLnDSm.js";import{C as n}from"./CodeBlock-B5pCUJyF.js";import{d as v,r as i,x as k,j as T,b as s,t as C,e as t,i as o,o as z}from"./index-CRuENrYq.js";import"./_commonjsHelpers-Cpj98o6Y.js";const E={class:"text-gray-500 mb-2 text-lg"},w={class:"text-gray-500 mb-2 text-lg"},D={class:"text-gray-500 mb-2 text-lg"},A={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},O={class:"text-gray-500 mb-2 text-lg"},I={class:"text-gray-500 mb-2 text-lg"},F={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},L="February 6, 2026",j=v({__name:"DataTypeIndex",setup(U){const e=i(`
int x = 10;   // valid
int x = 5;    // valid
