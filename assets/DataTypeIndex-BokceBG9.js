import{_ as z}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-BilWcdN8.js";import{C as e}from"./CodeBlock-BcGcsIUU.js";import{_ as E}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-0RVgxKdU.js";import{O as o}from"./OutputBlock-CdA9ge79.js";import{d as w,r as i,p as D,l as O,a as t,k as n,t as S,e as s,o as A}from"./index-BbkNKk44.js";import"./Footer.vue_vue_type_script_setup_true_lang-Ru-ZxfwF.js";const I={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},F={class:"text-gray-500 mb-2 text-lg"},P={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},R={class:"text-gray-500 mb-2 text-lg"},G="February 6, 2026",Y=w({__name:"DataTypeIndex",setup(W){const r=i(`
int x = 10;   // valid
int x = 5;    // valid
