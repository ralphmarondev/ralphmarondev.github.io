import{_ as z}from"./MainLayout.vue_vue_type_style_index_0_lang-BnMcHLIP.js";import{C as e,_ as E}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-BGxgIw6C.js";import{O as o}from"./OutputBlock-BJ7RIbr6.js";import{d as w,r as i,z as D,j as O,b as t,i as n,t as S,e as s,o as A}from"./index-Bk0_C35p.js";const I={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},F={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},P={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},R={class:"text-gray-500 mb-2 text-lg"},G="February 6, 2026",Q=w({__name:"DataTypeIndex",setup(W){const r=i(`
int x = 10;   // valid
int x = 5;    // valid
