import{_ as z}from"./TutorialMainLayout.vue_vue_type_script_setup_true_lang-BX7JLS4I.js";import{C as e}from"./CodeBlock-Du5Y_F6b.js";import{O as o}from"./OutputBlock-CIA53ZQ5.js";import{u as E}from"./cProgramming-CqS8EQI1.js";import{d as D,r as i,p as w,l as O,m as S,o as A,a as t,t as N,b as s,k as n}from"./index-BPX1bKrC.js";const F={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},I={class:"text-gray-500 mb-2 text-lg"},P={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},R={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},G={class:"text-gray-500 mb-2 text-lg"},W="February 6, 2026",Y=D({__name:"DataTypeIndex",setup(j){const r=E(),a=i(`
int x = 10;   // valid
int x = 5;    // valid
