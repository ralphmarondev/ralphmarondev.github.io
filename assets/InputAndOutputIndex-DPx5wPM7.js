import{_ as m}from"./TutorialMainLayout.vue_vue_type_script_setup_true_lang-pHU7Iykn.js";import{C as i}from"./CodeBlock-Dq1Y_ZOo.js";import{u as x}from"./cProgramming-MNohmiCX.js";import{d as b,r as e,p as c,l as y,m as k,o as v,a as s,t as w,b as n,k as l}from"./index-DzB2MRah.js";const h={class:"text-gray-500 mb-2 text-lg"},T={class:"text-gray-500 mb-2 text-lg"},I={class:"text-gray-500 mb-2 text-lg"},C={class:"text-gray-500 mb-2 text-lg"},E={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},F="February 16, 2026",L=b({__name:"InputAndOutputIndex",setup(V){const a=x(),r=e(`
#include <stdio.h>
