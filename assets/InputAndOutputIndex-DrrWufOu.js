import{_ as m}from"./MainLayout.vue_vue_type_style_index_0_lang-COkVKPSQ.js";import{C as l,_ as x}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-vUkPcjSL.js";import{d as b,r as e,z as c,j as y,b as t,i,t as k,e as n,o as w}from"./index-C9kXZoCP.js";const v={class:"text-gray-500 mb-2 text-lg"},h={class:"text-gray-500 mb-2 text-lg"},T={class:"text-gray-500 mb-2 text-lg"},I={class:"text-gray-500 mb-2 text-lg"},C={class:"text-gray-500 mb-2 text-lg"},E={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},S="February 16, 2026",L=b({__name:"InputAndOutputIndex",setup(V){const a=e(`
#include <stdio.h>
