import{_ as c}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-jVFum5Vs.js";import{C as s}from"./CodeBlock-0PUBvTWf.js";import{O as o}from"./OutputBlock-CS2VfiLX.js";import{d as v,r as i,p as F,l as k,a as t,t as w,e as n,k as e,o as D}from"./index-DKpDr1dj.js";import"./Footer.vue_vue_type_script_setup_true_lang-DivT-Fsh.js";const T={class:"text-gray-500 mb-2 text-lg"},C={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},A={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},W="March 30, 2026",L=v({__name:"IntroductionIndex",setup(R){const a=i(`
#include <stdio.h>
