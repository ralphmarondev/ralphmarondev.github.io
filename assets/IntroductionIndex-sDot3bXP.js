import{_ as c}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-wnLsKI1e.js";import{C as s}from"./CodeBlock-D8cbajus.js";import{O as o}from"./OutputBlock-DBUi5rzu.js";import{d as v,r as i,p as F,l as k,a as t,t as w,e as n,k as e,o as D}from"./index-BoiLWSy3.js";import"./Footer.vue_vue_type_script_setup_true_lang-CUCs2pT8.js";const T={class:"text-gray-500 mb-2 text-lg"},C={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},A={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},W="March 30, 2026",L=v({__name:"IntroductionIndex",setup(R){const a=i(`
#include <stdio.h>
