import{_ as y}from"./MainLayout.vue_vue_type_style_index_0_lang-7SHu24Ay.js";import{C as i,_ as k}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-CEWJDlzx.js";import{d as w,r as s,x as v,j as L,b as o,i as n,t as E,e as l,o as C}from"./index-BZ3sbN9A.js";import"./Footer.vue_vue_type_script_setup_true_lang-BqkOyQgw.js";const U={class:"text-gray-500 mb-2 text-lg"},I={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},j={class:"text-gray-500 mb-2 text-lg"},T={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},B="February 16, 2026",q=w({__name:"LoopsIndex",setup(P){const e=s(`
