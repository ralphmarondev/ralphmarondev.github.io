import{_ as L}from"./MainLayout.vue_vue_type_style_index_0_lang-BnMcHLIP.js";import{C as s,_ as k}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-BGxgIw6C.js";import{O as u}from"./OutputBlock-BJ7RIbr6.js";import{d as R,r,z as w,j as A,b as t,i as e,t as E,e as n,o as B,_ as C}from"./index-Bk0_C35p.js";const D={class:"text-gray-500 mb-2 text-lg"},I={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},T={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},q={class:"text-gray-500 mb-2 text-lg"},z="February 16, 2026",P=R({__name:"OperatorsIndex",setup(S){const i=r(`
#include <stdio.h>
