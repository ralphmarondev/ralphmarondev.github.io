import{_ as f}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-BilWcdN8.js";import{C as n}from"./CodeBlock-BcGcsIUU.js";import{d as y,r as l,p as b,l as v,a as s,t as P,e,k as i,o as k}from"./index-BbkNKk44.js";import"./Footer.vue_vue_type_script_setup_true_lang-Ru-ZxfwF.js";const T={class:"text-gray-500 mb-2 text-lg"},A={class:"text-gray-500 mb-2 text-lg"},C={class:"text-gray-500 mb-2 text-lg"},w={class:"text-gray-500 mb-2 text-lg"},V={class:"text-gray-500 mb-2 text-lg"},O={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},D={class:"text-gray-500 mb-2 text-lg"},M="March 30, 2026",I=y({__name:"PointersIntroductionIndex",setup(B){const r=l(`
#include <stdio.h>
