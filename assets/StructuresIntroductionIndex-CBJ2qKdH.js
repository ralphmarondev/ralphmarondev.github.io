import{_ as p}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-T_F0xssW.js";import{C as r}from"./CodeBlock-BawFMjar.js";import{O as u}from"./OutputBlock-X97pfRco.js";import{d as y,r as a,s as c,j as b,a as e,t as f,e as s,h as l,o as S}from"./index-V7ZTurBu.js";import"./Footer.vue_vue_type_script_setup_true_lang-X364togL.js";const v={class:"text-gray-500 mb-2 text-lg"},C={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},k={class:"text-gray-500 mb-2 text-lg"},w={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},N="March 30, 2026",I=y({__name:"StructuresIntroductionIndex",setup(A){const n=a(`
char name[50];
int age;
float grade;
`),i=a(`
