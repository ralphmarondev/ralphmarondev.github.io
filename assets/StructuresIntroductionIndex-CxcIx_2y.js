import{_ as y}from"./TutorialMainLayout.vue_vue_type_script_setup_true_lang-BX7JLS4I.js";import{C as r}from"./CodeBlock-Du5Y_F6b.js";import{O as n}from"./OutputBlock-CIA53ZQ5.js";import{u as c}from"./cProgramming-CqS8EQI1.js";import{d as b,r as a,p as f,l as S,m as v,o as C,a as e,t as U,b as s,k as l}from"./index-BPX1bKrC.js";const k={class:"text-gray-500 mb-2 text-lg"},w={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},A={class:"text-gray-500 mb-2 text-lg"},P={class:"text-gray-500 mb-2 text-lg"},W="March 30, 2026",D=b({__name:"StructuresIntroductionIndex",setup(M){const u=c(),o=a(`
char name[50];
int age;
float grade;
`),i=a(`
