import{_ as I}from"./TutorialMainLayout.vue_vue_type_style_index_0_lang-T_F0xssW.js";import{C as i}from"./CodeBlock-BawFMjar.js";import{O as n}from"./OutputBlock-X97pfRco.js";import{_ as A}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-MNQ5aC5H.js";import{d as C,r as s,s as E,j as T,a as l,h as a,t as O,e,o as z}from"./index-V7ZTurBu.js";import"./Footer.vue_vue_type_script_setup_true_lang-X364togL.js";const D={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},W={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},K="February 6, 2026",J=C({__name:"VariablesIndex",setup(P){const r=s(`
int age;
float height;
char grade;
`),o=s(`
