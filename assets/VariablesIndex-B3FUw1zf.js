import{_ as I}from"./MainLayout.vue_vue_type_style_index_0_lang-COkVKPSQ.js";import{C as n,_ as A}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-vUkPcjSL.js";import{O as i}from"./OutputBlock-DtI5Zloi.js";import{d as C,r as s,z as E,j as T,b as l,i as a,t as z,e,o as O}from"./index-C9kXZoCP.js";const D={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},W={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},K="February 6, 2026",F=C({__name:"VariablesIndex",setup(G){const r=s(`
int age;
float height;
char grade;
`),o=s(`
