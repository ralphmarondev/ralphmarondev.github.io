import{_ as I}from"./TutorialMainLayout.vue_vue_type_script_setup_true_lang-Iid74Gt7.js";import{C as n}from"./CodeBlock-EK9_wzx3.js";import{O as i}from"./OutputBlock-Bt5idpCC.js";import{u as A}from"./cProgramming-CgDASWC3.js";import{d as E,r as s,p as C,l as T,m as z,o as D,a as t,t as O,b as a,k as e}from"./index-COhN-orq.js";const N={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},W={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},P={class:"text-gray-500 mb-2 text-lg"},G="February 6, 2026",J=E({__name:"VariablesIndex",setup(K){const r=A(),o=s(`
int age;
float height;
char grade;
`),u=s(`
