import{_ as I}from"./MainLayout.vue_vue_type_style_index_0_lang-7SHu24Ay.js";import{C as i,_ as A}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-CEWJDlzx.js";import{O as n}from"./OutputBlock-Bix21cFd.js";import{d as C,r as s,x as E,j as T,b as l,i as a,t as O,e,o as z}from"./index-BZ3sbN9A.js";import"./Footer.vue_vue_type_script_setup_true_lang-BqkOyQgw.js";const D={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},W={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},K="February 6, 2026",Y=C({__name:"VariablesIndex",setup(G){const r=s(`
int age;
float height;
char grade;
`),o=s(`
