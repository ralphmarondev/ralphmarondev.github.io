import{_ as k}from"./MainLayout.vue_vue_type_style_index_0_lang-9gUT_XFJ.js";import{C as n}from"./CodeBlock-CdVZTHbd.js";import{O as i}from"./OutputBlock-CZX1MebP.js";import{d as I,r as s,y as A,j as E,b as t,t as T,e,i as a,o as C}from"./index-CwgypZy3.js";const z={class:"text-gray-500 mb-2 text-lg"},D={class:"text-gray-500 mb-2 text-lg"},O={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},W={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},H="February 6, 2026",F=I({__name:"VariablesIndex",setup(L){const r=s(`
int age;
float height;
char grade;
`),o=s(`
