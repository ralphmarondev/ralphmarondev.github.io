import{_ as I}from"./MainLayout.vue_vue_type_style_index_0_lang-BAgJvh8v.js";import{C as i}from"./CodeBlock-4mduecGU.js";import{O as n}from"./OutputBlock-DQW-8KI-.js";import{_ as A}from"./UsefulLinks.vue_vue_type_script_setup_true_lang-CdX8lEh_.js";import{d as C,r as s,y as E,j as T,b as l,i as a,t as O,e,o as z}from"./index-Dgoy4z9j.js";const D={class:"text-gray-500 mb-2 text-lg"},N={class:"text-gray-500 mb-2 text-lg"},S={class:"text-gray-500 mb-2 text-lg"},W={class:"text-gray-500 mb-2 text-lg"},B={class:"text-gray-500 mb-2 text-lg"},M={class:"text-gray-500 mb-2 text-lg"},U={class:"text-gray-500 mb-2 text-lg"},L={class:"text-gray-500 mb-2 text-lg"},H={class:"text-gray-500 mb-2 text-lg"},K="February 6, 2026",Y=C({__name:"VariablesIndex",setup(G){const r=s(`
int age;
float height;
char grade;
`),o=s(`
