const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CProgrammingIndex-F8E9jjoN.js","assets/MainLayout.vue_vue_type_style_index_0_lang-CSSDpK-H.js","assets/MainLayout-DOIhJtcZ.css","assets/IntroductionIndex-CsQmFy85.js","assets/CompilationProcessIndex-DYgcCcEJ.js","assets/IdentifiersIndex-BBoc8g2i.js","assets/CodeBlock.vue_vue_type_script_setup_true_lang-BWVkeT2n.js","assets/IdentifiersIndex-CwVx3w-h.css","assets/KeywordsIndex-D3EVULTH.js","assets/KeywordsIndex-DRN50rYe.css","assets/VariablesIndex-dtqjeuck.js","assets/DataTypeIndex-CiFknAos.js","assets/QuizOneIndex-CnT20caj.js","assets/InputAndOutputIndex-CNSFge3w.js","assets/OperatorsIndex-CKSfJcGl.js","assets/QuizTwoIndex-JFBl3XkR.js","assets/ConditionalStatementsIndex-DsqlFMDd.js","assets/LoopsIndex-BC5l1ikk.js","assets/QuizThreeIndex-CAuTrMS9.js","assets/PortfolioIndex-DPZ2EAro.js","assets/useThemeStore-D4W6TDO4.js","assets/PortfolioIndex-CY81tie6.css","assets/BlogIndex-BHNTmKnL.js","assets/BlogIndex-Cx_9sonR.css","assets/LoginIndex-DjQS8t0x.js","assets/LoginIndex-y6PUChAD.css","assets/DashboardIndex-cnRGCtyN.js","assets/MainLayout.vue_vue_type_style_index_0_lang-CPKLFsAw.js","assets/MainLayout-C5W30ZTt.css","assets/MemoryListIndex-Ce_fI0Br.js","assets/storageUtils-BoT0UcA7.js","assets/useMemoriesStore-BUdqSO_n.js","assets/MemoryListIndex-BAK2Hw1e.css","assets/DetailsIndex-CMfTaHDO.js","assets/DetailsIndex-DILrBQYv.css","assets/NewMemoryIndex-Cy8F0iJd.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TS=300,vS=Cg("authIdTokenMaxAge")||TS;let Md=null;const IS=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>vS)return;const s=n?.token;Md!==s&&(Md=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Ho(t=Eu()){const e=Wa(t,"auth");if(e.isInitialized())return e.getImmediate();const n=WR(t,{popupRedirectResolver:gS,persistence:[Sb,a_,l_]}),r=Cg("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=IS(i.toString());hb(n,o,()=>o(n.currentUser)),ub(n,c=>o(c))}}const s=bg("auth");return s&&GR(n,`http://${s}`),n}function wS(){return document.getElementsByTagName("head")?.[0]??document}UR({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=un("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",wS().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});ES("Browser");const AS=EI("auth",()=>{const t=Ni(null),e=Ni(!0);return{user:t,loading:e,login:async(i,o)=>{const c=Ho(),l=await cb(c,i,o);t.value={email:l.user.email??""}},logout:async()=>{const i=Ho();await db(i),t.value=null},fetchUser:()=>new Promise(i=>{const o=Ho();fb(o,c=>{t.value=c?{email:c.email??""}:null,e.value=!1,i()})})}}),RS=[{path:"/blog/c-programming-language",name:"c-programming",component:()=>Be(()=>import("./CProgrammingIndex-F8E9jjoN.js"),__vite__mapDeps([0,1,2])),meta:{title:"C Programming Tutorial",icon:"/ralphmaron.png"}},{path:"/blog/c-introduction",name:"c-introduction",component:()=>Be(()=>import("./IntroductionIndex-CsQmFy85.js"),__vite__mapDeps([3,1,2])),meta:{title:"C Language Introduction",icon:"/ralphmaron.png"}},{path:"/blog/c-compilation-process",name:"c-compilation-process",component:()=>Be(()=>import("./CompilationProcessIndex-DYgcCcEJ.js"),__vite__mapDeps([4,1,2])),meta:{title:"C Compilation Process",icon:"/ralphmaron.png"}},{path:"/blog/c-identifiers",name:"c-identifiers",component:()=>Be(()=>import("./IdentifiersIndex-BBoc8g2i.js"),__vite__mapDeps([5,1,2,6,7])),meta:{title:"Identifiers in C",icon:"/ralphmaron.png"}},{path:"/blog/c-keywords",name:"c-keywords",component:()=>Be(()=>import("./KeywordsIndex-D3EVULTH.js"),__vite__mapDeps([8,1,2,6,9])),meta:{title:"Identifiers in C",icon:"/ralphmaron.png"}},{path:"/blog/c-variables",name:"c-variables",component:()=>Be(()=>import("./VariablesIndex-dtqjeuck.js"),__vite__mapDeps([10,1,2,6])),meta:{title:"C Language Variables",icon:"/ralphmaron.png"}},{path:"/blog/c-data-types",name:"c-data-types",component:()=>Be(()=>import("./DataTypeIndex-CiFknAos.js"),__vite__mapDeps([11,1,2,6])),meta:{title:"C Data Types",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-basics",name:"c-quiz-basics",component:()=>Be(()=>import("./QuizOneIndex-CnT20caj.js"),__vite__mapDeps([12,1,2])),meta:{title:"C - Quiz One",icon:"/ralphmaron.png"}},{path:"/blog/c-input-output",name:"c-input-output",component:()=>Be(()=>import("./InputAndOutputIndex-CNSFge3w.js"),__vite__mapDeps([13,1,2])),meta:{title:"C Input and Output",icon:"/ralphmaron.png"}},{path:"/blog/c-operators",name:"c-operators",component:()=>Be(()=>import("./OperatorsIndex-CKSfJcGl.js"),__vite__mapDeps([14,1,2])),meta:{title:"C Operators",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-io-operators",name:"c-quiz-io-operators",component:()=>Be(()=>import("./QuizTwoIndex-JFBl3XkR.js"),__vite__mapDeps([15,1,2])),meta:{title:"C - Quiz Two",icon:"/ralphmaron.png"}},{path:"/blog/c-conditional-statements",name:"c-conditional-statements",component:()=>Be(()=>import("./ConditionalStatementsIndex-DsqlFMDd.js"),__vite__mapDeps([16,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}},{path:"/blog/c-loops",name:"c-loops",component:()=>Be(()=>import("./LoopsIndex-BC5l1ikk.js"),__vite__mapDeps([17,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-conditional-loops",name:"c-quiz-conditional-loops",component:()=>Be(()=>import("./QuizThreeIndex-CAuTrMS9.js"),__vite__mapDeps([18,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}}],g_=Pw({history:rw(),routes:[{path:"/",name:"portfolio",component:()=>Be(()=>import("./PortfolioIndex-DPZ2EAro.js"),__vite__mapDeps([19,20,21])),meta:{title:"Ralph Maron Eda",icon:"/ralphmaron.png"}},{path:"/blog",name:"blog",component:()=>Be(()=>import("./BlogIndex-BHNTmKnL.js"),__vite__mapDeps([22,1,2,23])),meta:{title:"Blogs",icon:"/ralphmaron.png"}},...RS,{path:"/login",name:"login",component:()=>Be(()=>import("./LoginIndex-DjQS8t0x.js"),__vite__mapDeps([24,25])),meta:{title:"Login",icon:"/favicon.jpg"}},{path:"/dashboard",name:"dashboard",component:()=>Be(()=>import("./DashboardIndex-cnRGCtyN.js"),__vite__mapDeps([26,27,20,28])),meta:{requiresAuth:!0,title:"Dashboard",icon:"/favicon.jpg"}},{path:"/memories",name:"memories",component:()=>Be(()=>import("./MemoryListIndex-Ce_fI0Br.js"),__vite__mapDeps([29,27,20,28,30,31,32])),meta:{requiresAuth:!0,title:"Memories",icon:"/favicon.jpg"}},{path:"/details/:id",name:"details",component:()=>Be(()=>import("./DetailsIndex-CMfTaHDO.js"),__vite__mapDeps([33,27,20,28,31,30,34])),meta:{requiresAuth:!0,title:"Details",icon:"/favicon.jpg"}},{path:"/new-memory",name:"new-memory",component:()=>Be(()=>import("./NewMemoryIndex-Cy8F0iJd.js"),__vite__mapDeps([35,27,20,28,31])),meta:{requiresAuth:!0,title:"New Memory",icon:"/favicon.jpg"}},{path:"/:pathMatch(.*)*",name:"not-found",component:()=>Be(()=>import("./NotFound-CSBipU5b.js"),[]),meta:{title:"Page Not Found",icon:"/favicon.jpg"}}],scrollBehavior(t){return t.hash?{el:t.hash,behavior:"smooth"}:{top:0}}});g_.beforeEach(async(t,e,n)=>{const r=AS();if(t.meta.requiresAuth&&(!r.user&&r.loading&&await r.fetchUser(),!r.user))return n({name:"login"});if(t.meta?.title&&(document.title=t.meta.title),t.meta?.icon){const s=document.querySelector("link[rel~='icon']")||document.createElement("link");s.rel="icon",s.href=t.meta.icon,document.head.appendChild(s)}n()});var bS="firebase",SS="12.7.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var je;(function(t){t.UNKNOWN="unknown",t.OBJECT_NOT_FOUND="object-not-found",t.BUCKET_NOT_FOUND="bucket-not-found",t.PROJECT_NOT_FOUND="project-not-found",t.QUOTA_EXCEEDED="quota-exceeded",t.UNAUTHENTICATED="unauthenticated",t.UNAUTHORIZED="unauthorized",t.UNAUTHORIZED_APP="unauthorized-app",t.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",t.INVALID_CHECKSUM="invalid-checksum",t.CANCELED="canceled",t.INVALID_EVENT_NAME="invalid-event-name",t.INVALID_URL="invalid-url",t.INVALID_DEFAULT_BUCKET="invalid-default-bucket",t.NO_DEFAULT_BUCKET="no-default-bucket",t.CANNOT_SLICE_BLOB="cannot-slice-blob",t.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",t.NO_DOWNLOAD_URL="no-download-url",t.INVALID_ARGUMENT="invalid-argument",t.INVALID_ARGUMENT_COUNT="invalid-argument-count",t.APP_DELETED="app-deleted",t.INVALID_ROOT_OPERATION="invalid-root-operation",t.INVALID_FORMAT="invalid-format",t.INTERNAL_ERROR="internal-error",t.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(je||(je={}));function Qc(t){return"storage/"+t}function Pu(){const t="An unknown error occurred, please check the error payload for server response.";return new $e(je.UNKNOWN,t)}function kS(t){return new $e(je.OBJECT_NOT_FOUND,"Object '"+t+"' does not exist.")}function NS(t){return new $e(je.QUOTA_EXCEEDED,"Quota for bucket '"+t+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function DS(){const t="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new $e(je.UNAUTHENTICATED,t)}function OS(){return new $e(je.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function VS(t){return new $e(je.UNAUTHORIZED,"User does not have permission to access '"+t+"'.")}function xS(){return new $e(je.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function LS(){return new $e(je.CANCELED,"User canceled the upload/download.")}function MS(t){return new $e(je.INVALID_URL,"Invalid URL '"+t+"'.")}function US(t){return new $e(je.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+t+"'.")}function FS(){return new $e(je.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+y_+"' property when initializing the app?")}function BS(){return new $e(je.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function jS(){return new $e(je.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function $S(t){return new $e(je.UNSUPPORTED_ENVIRONMENT,`${t} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function Sl(t){return new $e(je.INVALID_ARGUMENT,t)}function E_(){return new $e(je.APP_DELETED,"The Firebase app was deleted.")}function qS(t){return new $e(je.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Ai(t,e){return new $e(je.INVALID_FORMAT,"String does not match format '"+t+"': "+e)}function ii(t){throw new $e(je.INTERNAL_ERROR,"Internal error: "+t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zS(t,e,n){let r=1,s=null,i=null,o=!1,c=0;function l(){return c===2}let u=!1;function f(...D){u||(u=!0,e.apply(null,D))}function p(D){s=setTimeout(()=>{s=null,t(E,l())},D)}function m(){i&&clearTimeout(i)}function E(D,...B){if(u){m();return}if(D){m(),f.call(null,D,...B);return}if(l()||o){m(),f.call(null,D,...B);return}r<64&&(r*=2);let j;c===1?(c=2,j=0):j=(r+Math.random())*1e3,p(j)}let P=!1;function N(D){P||(P=!0,m(),!u&&(s!==null?(D||(c=2),clearTimeout(s),p(0)):D||(c=1)))}return p(0),i=setTimeout(()=>{o=!0,N(!0)},n),N}function WS(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hr{constructor(e,n){this._service=e,n instanceof xt?this._location=n:this._location=xt.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new Hr(e,n)}get root(){const e=new xt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return R_(this._location.path)}get storage(){return this._service}get parent(){const e=hP(this._location.path);if(e===null)return null;const n=new xt(this._location.bucket,e);return new Hr(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw qS(e)}}function PP(t,e,n){t._throwIfRoot("uploadBytes");const r=RP(t.storage,t._location,b_(),new er(e,!0),n);return t.storage.makeRequestWithTokens(r,N_).then(s=>({metadata:s,ref:t}))}function CP(t){t._throwIfRoot("getDownloadURL");const e=IP(t.storage,t._location,b_());return t.storage.makeRequestWithTokens(e,N_).then(n=>{if(n===null)throw jS();return n})}function kP(t,e){const n=fP(t._location.path,e),r=new xt(t._location.bucket,n);return new Hr(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O_="storage";function _k(t,e,n){return t=Me(t),PP(t,e,n)}function yk(t){return t=Me(t),CP(t)}function Ek(t,e){return t=Me(t),OP(t,e)}function xP(t=Eu(),e){t=Me(t);const r=Wa(t,O_).getImmediate({identifier:e}),s=Sg("storage");return s&&LP(r,...s),r}function LP(t,e,n,r={}){VP(t,e,n,r)}function MP(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new Du(n,r,s,e,Gr)}function UP(){$r(new fr(O_,MP,"PUBLIC").setMultipleInstances(!0)),ln(jd,$d,""),ln(jd,$d,"esm2020")}UP();var qd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j_{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class FP{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable((()=>n(pt.UNAUTHENTICATED)))}shutdown(){}}class BP{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable((()=>n(this.token.user)))}shutdown(){this.changeListener=null}}class jP{constructor(e){this.t=e,this.currentUser=pt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){Re(this.o===void 0,42304);let r=this.i;const s=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let i=new cr;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new cr,e.enqueueRetryable((()=>s(this.currentUser)))};const o=()=>{const l=i;e.enqueueRetryable((async()=>{await l.promise,await s(this.currentUser)}))},c=l=>{J("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit((l=>c(l))),setTimeout((()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(J("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new cr)}}),0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then((r=>this.i!==e?(J("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Re(typeof r.accessToken=="string",31837,{l:r}),new j_(r.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Re(e===null||typeof e=="string",2055,{h:e}),new pt(e)}}class $P{constructor(e,n,r){this.P=e,this.T=n,this.I=r,this.type="FirstParty",this.user=pt.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const e=this.R();return e&&this.A.set("Authorization",e),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class qP{constructor(e,n,r){this.P=e,this.T=n,this.I=r}getToken(){return Promise.resolve(new $P(this.P,this.T,this.I))}start(e,n){e.enqueueRetryable((()=>n(pt.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Wd{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class HP{constructor(e,n){this.V=n,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Ft(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,n){Re(this.o===void 0,3512);const r=i=>{i.error!=null&&J("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.m;return this.m=i.token,J("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable((()=>r(i)))};const s=i=>{J("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((i=>s(i))),setTimeout((()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):J("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new Wd(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((n=>n?(Re(typeof n.token=="string",44558,{tokenResult:n}),this.m=n.token,new Wd(n.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ls(t){if(t.code!==x.FAILED_PRECONDITION||t.message!==ZP)throw t;J("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AC=new Ue(te.comparator);function Vn(){return AC}const uy=new Ue(te.comparator);function ui(...t){let e=uy;for(const n of t)e=e.insert(n.key,n);return e}function hy(t){let e=uy;return t.forEach(((n,r)=>e=e.insert(n,r.overlayedDocument))),e}function Mr(){return Si()}function fy(){return Si()}function Si(){return new Xr((t=>t.toString()),((t,e)=>t.isEqual(e)))}const RC=new Ue(te.comparator),bC=new Ye(te.comparator);function _e(...t){let e=bC;for(const n of t)e=e.add(n);return e}const SC=new Ye(ge);function PC(){return SC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class g0{constructor(){this.changes=new Xr((e=>e.toString()),((e,n)=>e.isEqual(n))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,gt.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?M.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class v0{constructor(){this.sessionToken=ct.EMPTY_BYTE_STRING}getSessionToken(e){return M.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,M.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P0{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return Kw()?8:tC(Et())>0?6:4})()}initialize(e,n){this.ps=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ys(e,n).next((o=>{i.result=o})).next((()=>{if(!i.result)return this.ws(e,n,s,r).next((o=>{i.result=o}))})).next((()=>{if(i.result)return;const o=new S0;return this.Ss(e,n,o).next((c=>{if(i.result=c,this.Vs)return this.bs(e,n,o,c.size)}))})).next((()=>i.result))}bs(e,n,r,s){return r.documentReadCount<this.fs?(as()<=me.DEBUG&&J("QueryEngine","SDK will not create cache indexes for query:",cs(n),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),M.resolve()):(as()<=me.DEBUG&&J("QueryEngine","Query:",cs(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.gs*s?(as()<=me.DEBUG&&J("QueryEngine","The SDK decides to create cache indexes for query:",cs(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,fn(n))):M.resolve())}ys(e,n){if(lp(n))return M.resolve(null);let r=fn(n);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(n.limit!==null&&s===1&&(n=xl(n,null,"F"),r=fn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next((i=>{const o=_e(...i);return this.ps.getDocuments(e,o).next((c=>this.indexManager.getMinOffset(e,r).next((l=>{const u=this.Ds(n,c);return this.Cs(n,u,o,l.readTime)?this.ys(e,xl(n,null,"F")):this.vs(e,u,n,l)}))))})))))}ws(e,n,r,s){return lp(n)||s.isEqual(le.min())?M.resolve(null):this.ps.getDocuments(e,r).next((i=>{const o=this.Ds(n,i);return this.Cs(n,o,r,s)?M.resolve(null):(as()<=me.DEBUG&&J("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),cs(n)),this.vs(e,o,n,XP(s,qi)).next((c=>c)))}))}Ds(e,n){let r=new Ye(ly(e));return n.forEach(((s,i)=>{nc(e,i)&&(r=r.add(i))})),r}Cs(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Ss(e,n,r){return as()<=me.DEBUG&&J("QueryEngine","Using full collection scan to execute query:",cs(n)),this.ps.getDocumentsMatchingQuery(e,n,dr.min(),r)}vs(e,n,r,s){return this.ps.getDocumentsMatchingQuery(e,r,s).next((i=>(n.forEach((o=>{i=i.insert(o.key,o)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
