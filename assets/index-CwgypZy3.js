const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CProgrammingIndex-BcPsfkAD.js","assets/MainLayout.vue_vue_type_style_index_0_lang-9gUT_XFJ.js","assets/MainLayout-DOIhJtcZ.css","assets/IntroductionIndex-B98UAHPc.js","assets/CodeBlock-CdVZTHbd.js","assets/CodeBlock-ViIDlLg1.css","assets/OutputBlock-CZX1MebP.js","assets/OutputBlock-DUgFQ7Zw.css","assets/CompilationProcessIndex-CAoB2d2x.js","assets/IdentifiersIndex-CA0-WzPa.js","assets/IdentifiersIndex-P3PbYShb.css","assets/KeywordsIndex-BmmU7KN-.js","assets/KeywordsIndex-D99_SN2F.css","assets/VariablesIndex-DQwIv1bP.js","assets/DataTypeIndex-D9sUFRX5.js","assets/QuizOneIndex-ZIANXgSM.js","assets/InputAndOutputIndex-CUph6YN4.js","assets/OperatorsIndex-CfS4rVJR.js","assets/QuizTwoIndex-NQeDkbwT.js","assets/ConditionalStatementsIndex-BgUHu66n.js","assets/LoopsIndex-8-BuPxdt.js","assets/QuizThreeIndex-DQeO9gVq.js","assets/LoginIndex-CHre4mdh.js","assets/LoginIndex-C-ymjigd.css","assets/DashboardIndex-D2fTNFlJ.js","assets/MainLayout.vue_vue_type_style_index_0_lang-XUBCvz-N.js","assets/useThemeStore-h4x-EFC4.js","assets/MainLayout-8ZLcnXjI.css","assets/MemoryListIndex-B9-1Ui61.js","assets/storageUtils-BmULdCNP.js","assets/useMemoriesStore-BV_nj3Sj.js","assets/MemoryListIndex-CtxJ-zIk.css","assets/DetailsIndex-C58iuY6A.js","assets/DetailsIndex-0yvoXKcq.css","assets/NewMemoryIndex-BrIxsoon.js","assets/PortfolioIndex-C1TqMNgZ.js","assets/PortfolioIndex-B8Au0Qul.css","assets/BlogIndex-CZsxI8tI.js","assets/BlogIndex-Cx_9sonR.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RS=300,SS=Nm("authIdTokenMaxAge")||RS;let Bd=null;const PS=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>SS)return;const s=n?.token;Bd!==s&&(Bd=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Ho(t=vu()){const e=Wa(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Jb(t,{popupRedirectResolver:wS,persistence:[OR,u_,f_]}),r=Nm("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=PS(i.toString());_R(n,o,()=>o(n.currentUser)),mR(n,c=>o(c))}}const s=Cm("auth");return s&&eR(n,`http://${s}`),n}function CS(){return document.getElementsByTagName("head")?.[0]??document}Hb({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=fn("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",CS().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});bS("Browser");const kS=bw("auth",()=>{const t=Di(null),e=Di(!0);return{user:t,loading:e,login:async(i,o)=>{const c=Ho(),l=await pR(c,i,o);t.value={email:l.user.email??""}},logout:async()=>{const i=Ho();await ER(i),t.value=null},fetchUser:()=>new Promise(i=>{const o=Ho();yR(o,c=>{t.value=c?{email:c.email??""}:null,e.value=!1,i()})})}}),DS=[{path:"/blog/c-programming-language",name:"c-programming",component:()=>je(()=>import("./CProgrammingIndex-BcPsfkAD.js"),__vite__mapDeps([0,1,2])),meta:{title:"C Programming Tutorial",icon:"/ralphmaron.png"}},{path:"/blog/c-introduction",name:"c-introduction",component:()=>je(()=>import("./IntroductionIndex-B98UAHPc.js"),__vite__mapDeps([3,1,2,4,5,6,7])),meta:{title:"C Language Introduction",icon:"/ralphmaron.png"}},{path:"/blog/c-compilation-process",name:"c-compilation-process",component:()=>je(()=>import("./CompilationProcessIndex-CAoB2d2x.js"),__vite__mapDeps([8,1,2])),meta:{title:"C Compilation Process",icon:"/ralphmaron.png"}},{path:"/blog/c-identifiers",name:"c-identifiers",component:()=>je(()=>import("./IdentifiersIndex-CA0-WzPa.js"),__vite__mapDeps([9,1,2,4,5,6,7,10])),meta:{title:"Identifiers in C",icon:"/ralphmaron.png"}},{path:"/blog/c-keywords",name:"c-keywords",component:()=>je(()=>import("./KeywordsIndex-BmmU7KN-.js"),__vite__mapDeps([11,1,2,4,5,12])),meta:{title:"Identifiers in C",icon:"/ralphmaron.png"}},{path:"/blog/c-variables",name:"c-variables",component:()=>je(()=>import("./VariablesIndex-DQwIv1bP.js"),__vite__mapDeps([13,1,2,4,5,6,7])),meta:{title:"C Language Variables",icon:"/ralphmaron.png"}},{path:"/blog/c-data-types",name:"c-data-types",component:()=>je(()=>import("./DataTypeIndex-D9sUFRX5.js"),__vite__mapDeps([14,1,2,4,5])),meta:{title:"C Data Types",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-basics",name:"c-quiz-basics",component:()=>je(()=>import("./QuizOneIndex-ZIANXgSM.js"),__vite__mapDeps([15,1,2])),meta:{title:"Quiz Variables and Data Types in C",icon:"/ralphmaron.png"}},{path:"/blog/c-input-output",name:"c-input-output",component:()=>je(()=>import("./InputAndOutputIndex-CUph6YN4.js"),__vite__mapDeps([16,1,2])),meta:{title:"C Input and Output",icon:"/ralphmaron.png"}},{path:"/blog/c-operators",name:"c-operators",component:()=>je(()=>import("./OperatorsIndex-CfS4rVJR.js"),__vite__mapDeps([17,1,2])),meta:{title:"C Operators",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-io-operators",name:"c-quiz-io-operators",component:()=>je(()=>import("./QuizTwoIndex-NQeDkbwT.js"),__vite__mapDeps([18,1,2])),meta:{title:"C - Quiz Two",icon:"/ralphmaron.png"}},{path:"/blog/c-conditional-statements",name:"c-conditional-statements",component:()=>je(()=>import("./ConditionalStatementsIndex-BgUHu66n.js"),__vite__mapDeps([19,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}},{path:"/blog/c-loops",name:"c-loops",component:()=>je(()=>import("./LoopsIndex-8-BuPxdt.js"),__vite__mapDeps([20,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-conditional-loops",name:"c-quiz-conditional-loops",component:()=>je(()=>import("./QuizThreeIndex-DQeO9gVq.js"),__vite__mapDeps([21,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}}],NS=[...DS],OS=[{path:"/private/login",name:"login",component:()=>je(()=>import("./LoginIndex-CHre4mdh.js"),__vite__mapDeps([22,23])),meta:{title:"Login",icon:"/favicon.jpg"}},{path:"/private/dashboard",name:"dashboard",component:()=>je(()=>import("./DashboardIndex-D2fTNFlJ.js"),__vite__mapDeps([24,25,26,27])),meta:{requiresAuth:!0,title:"Dashboard",icon:"/favicon.jpg"}},{path:"/private/memories",name:"memories",component:()=>je(()=>import("./MemoryListIndex-B9-1Ui61.js"),__vite__mapDeps([28,25,26,27,29,30,31])),meta:{requiresAuth:!0,title:"Memories",icon:"/favicon.jpg"}},{path:"/private/details/:id",name:"details",component:()=>je(()=>import("./DetailsIndex-C58iuY6A.js"),__vite__mapDeps([32,25,26,27,30,29,33])),meta:{requiresAuth:!0,title:"Details",icon:"/favicon.jpg"}},{path:"/private/new-memory",name:"new-memory",component:()=>je(()=>import("./NewMemoryIndex-BrIxsoon.js"),__vite__mapDeps([34,25,26,27,30])),meta:{requiresAuth:!0,title:"New Memory",icon:"/favicon.jpg"}}],E_=VI({history:lI(),routes:[{path:"/",name:"portfolio",component:()=>je(()=>import("./PortfolioIndex-C1TqMNgZ.js"),__vite__mapDeps([35,26,36])),meta:{title:"Ralph Maron Eda",icon:"/ralphmaron.png"}},{path:"/blog",name:"blog",component:()=>je(()=>import("./BlogIndex-CZsxI8tI.js"),__vite__mapDeps([37,1,2,38])),meta:{title:"Blogs",icon:"/ralphmaron.png"}},...NS,...OS,{path:"/:pathMatch(.*)*",name:"not-found",component:()=>je(()=>import("./NotFound-CSeZha9V.js"),[]),meta:{title:"Page Not Found",icon:"/ralphmaron.png"}}],scrollBehavior(t){return t.hash?{el:t.hash,behavior:"smooth"}:{top:0}}});E_.beforeEach(async(t,e,n)=>{const r=kS();if(t.meta.requiresAuth&&(!r.user&&r.loading&&await r.fetchUser(),!r.user))return n({name:"login"});if(t.meta?.title&&(document.title=t.meta.title),t.meta?.icon){const s=document.querySelector("link[rel~='icon']")||document.createElement("link");s.rel="icon",s.href=t.meta.icon,document.head.appendChild(s)}n()});var VS="firebase",xS="12.7.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
