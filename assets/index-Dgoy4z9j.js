const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CProgrammingIndex-EeduFN_U.js","assets/MainLayout.vue_vue_type_style_index_0_lang-BAgJvh8v.js","assets/MainLayout-DOIhJtcZ.css","assets/IntroductionIndex-CPTjpHgc.js","assets/CodeBlock-4mduecGU.js","assets/CodeBlock-ViIDlLg1.css","assets/OutputBlock-DQW-8KI-.js","assets/OutputBlock-DUgFQ7Zw.css","assets/UsefulLinks.vue_vue_type_script_setup_true_lang-CdX8lEh_.js","assets/CompilationProcessIndex-C-Uc9gi0.js","assets/IdentifiersIndex-DXMClN8N.js","assets/IdentifiersIndex-yD7ddLFA.css","assets/KeywordsIndex-BdHp8p1K.js","assets/KeywordsIndex-CGuMYKw8.css","assets/VariablesIndex-PeyXCIX5.js","assets/DataTypeIndex-B-wXew_t.js","assets/QuizOneIndex-DJ1l0VkY.js","assets/InputAndOutputIndex-CAuXAsud.js","assets/OperatorsIndex-K9QFN1dO.js","assets/QuizTwoIndex-8deWeksI.js","assets/ConditionalStatementsIndex-CxWfCgim.js","assets/LoopsIndex-Oy9x7JgM.js","assets/QuizThreeIndex-GxnkmfEc.js","assets/LoginIndex-DQzoxN0n.js","assets/LoginIndex-C-ymjigd.css","assets/DashboardIndex-s1n-x0F_.js","assets/MainLayout.vue_vue_type_style_index_0_lang-D4CBABHR.js","assets/useThemeStore-m2tgkkUK.js","assets/MainLayout-8ZLcnXjI.css","assets/MemoryListIndex-DgIpn5hu.js","assets/storageUtils-BiZPb8wB.js","assets/useMemoriesStore-DPDId0GG.js","assets/MemoryListIndex-CtxJ-zIk.css","assets/DetailsIndex-Byc8Bo7S.js","assets/DetailsIndex-0yvoXKcq.css","assets/NewMemoryIndex-Bm7-LT0C.js","assets/PortfolioIndex-Cc7pMXuP.js","assets/PortfolioIndex-B8Au0Qul.css","assets/BlogIndex-DJ7UqlME.js","assets/BlogIndex-Cx_9sonR.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RS=300,SS=Nm("authIdTokenMaxAge")||RS;let Bd=null;const PS=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>SS)return;const s=n?.token;Bd!==s&&(Bd=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Ho(t=vu()){const e=Wa(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Jb(t,{popupRedirectResolver:wS,persistence:[OR,u_,f_]}),r=Nm("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=PS(i.toString());_R(n,o,()=>o(n.currentUser)),mR(n,c=>o(c))}}const s=Cm("auth");return s&&eR(n,`http://${s}`),n}function CS(){return document.getElementsByTagName("head")?.[0]??document}Hb({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=fn("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",CS().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});bS("Browser");const kS=bw("auth",()=>{const t=Di(null),e=Di(!0);return{user:t,loading:e,login:async(i,o)=>{const c=Ho(),l=await pR(c,i,o);t.value={email:l.user.email??""}},logout:async()=>{const i=Ho();await ER(i),t.value=null},fetchUser:()=>new Promise(i=>{const o=Ho();yR(o,c=>{t.value=c?{email:c.email??""}:null,e.value=!1,i()})})}}),DS=[{path:"/blog/c-programming-language",name:"c-programming",component:()=>je(()=>import("./CProgrammingIndex-EeduFN_U.js"),__vite__mapDeps([0,1,2])),meta:{title:"C Programming Tutorial",icon:"/ralphmaron.png"}},{path:"/blog/c-introduction",name:"c-introduction",component:()=>je(()=>import("./IntroductionIndex-CPTjpHgc.js"),__vite__mapDeps([3,1,2,4,5,6,7,8])),meta:{title:"C Language Introduction",icon:"/ralphmaron.png"}},{path:"/blog/c-compilation-process",name:"c-compilation-process",component:()=>je(()=>import("./CompilationProcessIndex-C-Uc9gi0.js"),__vite__mapDeps([9,1,2,8])),meta:{title:"C Compilation Process",icon:"/ralphmaron.png"}},{path:"/blog/c-identifiers",name:"c-identifiers",component:()=>je(()=>import("./IdentifiersIndex-DXMClN8N.js"),__vite__mapDeps([10,1,2,4,5,6,7,8,11])),meta:{title:"Identifiers in C",icon:"/ralphmaron.png"}},{path:"/blog/c-keywords",name:"c-keywords",component:()=>je(()=>import("./KeywordsIndex-BdHp8p1K.js"),__vite__mapDeps([12,1,2,4,5,8,13])),meta:{title:"Identifiers in C",icon:"/ralphmaron.png"}},{path:"/blog/c-variables",name:"c-variables",component:()=>je(()=>import("./VariablesIndex-PeyXCIX5.js"),__vite__mapDeps([14,1,2,4,5,6,7,8])),meta:{title:"C Language Variables",icon:"/ralphmaron.png"}},{path:"/blog/c-data-types",name:"c-data-types",component:()=>je(()=>import("./DataTypeIndex-B-wXew_t.js"),__vite__mapDeps([15,1,2,4,5,8,6,7])),meta:{title:"C Data Types",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-basics",name:"c-quiz-basics",component:()=>je(()=>import("./QuizOneIndex-DJ1l0VkY.js"),__vite__mapDeps([16,1,2])),meta:{title:"Quiz Variables and Data Types in C",icon:"/ralphmaron.png"}},{path:"/blog/c-input-output",name:"c-input-output",component:()=>je(()=>import("./InputAndOutputIndex-CAuXAsud.js"),__vite__mapDeps([17,1,2])),meta:{title:"C Input and Output",icon:"/ralphmaron.png"}},{path:"/blog/c-operators",name:"c-operators",component:()=>je(()=>import("./OperatorsIndex-K9QFN1dO.js"),__vite__mapDeps([18,1,2])),meta:{title:"C Operators",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-io-operators",name:"c-quiz-io-operators",component:()=>je(()=>import("./QuizTwoIndex-8deWeksI.js"),__vite__mapDeps([19,1,2])),meta:{title:"C - Quiz Two",icon:"/ralphmaron.png"}},{path:"/blog/c-conditional-statements",name:"c-conditional-statements",component:()=>je(()=>import("./ConditionalStatementsIndex-CxWfCgim.js"),__vite__mapDeps([20,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}},{path:"/blog/c-loops",name:"c-loops",component:()=>je(()=>import("./LoopsIndex-Oy9x7JgM.js"),__vite__mapDeps([21,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}},{path:"/blog/c-quiz-conditional-loops",name:"c-quiz-conditional-loops",component:()=>je(()=>import("./QuizThreeIndex-GxnkmfEc.js"),__vite__mapDeps([22,1,2])),meta:{title:"Conditional Statements",icon:"/ralphmaron.png"}}],NS=[...DS],OS=[{path:"/private/login",name:"login",component:()=>je(()=>import("./LoginIndex-DQzoxN0n.js"),__vite__mapDeps([23,24])),meta:{title:"Login",icon:"/favicon.jpg"}},{path:"/private/dashboard",name:"dashboard",component:()=>je(()=>import("./DashboardIndex-s1n-x0F_.js"),__vite__mapDeps([25,26,27,28])),meta:{requiresAuth:!0,title:"Dashboard",icon:"/favicon.jpg"}},{path:"/private/memories",name:"memories",component:()=>je(()=>import("./MemoryListIndex-DgIpn5hu.js"),__vite__mapDeps([29,26,27,28,30,31,32])),meta:{requiresAuth:!0,title:"Memories",icon:"/favicon.jpg"}},{path:"/private/details/:id",name:"details",component:()=>je(()=>import("./DetailsIndex-Byc8Bo7S.js"),__vite__mapDeps([33,26,27,28,31,30,34])),meta:{requiresAuth:!0,title:"Details",icon:"/favicon.jpg"}},{path:"/private/new-memory",name:"new-memory",component:()=>je(()=>import("./NewMemoryIndex-Bm7-LT0C.js"),__vite__mapDeps([35,26,27,28,31])),meta:{requiresAuth:!0,title:"New Memory",icon:"/favicon.jpg"}}],E_=VI({history:lI(),routes:[{path:"/",name:"portfolio",component:()=>je(()=>import("./PortfolioIndex-Cc7pMXuP.js"),__vite__mapDeps([36,27,37])),meta:{title:"Ralph Maron Eda",icon:"/ralphmaron.png"}},{path:"/blog",name:"blog",component:()=>je(()=>import("./BlogIndex-DJ7UqlME.js"),__vite__mapDeps([38,1,2,39])),meta:{title:"Blogs",icon:"/ralphmaron.png"}},...NS,...OS,{path:"/:pathMatch(.*)*",name:"not-found",component:()=>je(()=>import("./NotFound-DCwjtiH2.js"),[]),meta:{title:"Page Not Found",icon:"/ralphmaron.png"}}],scrollBehavior(t){return t.hash?{el:t.hash,behavior:"smooth"}:{top:0}}});E_.beforeEach(async(t,e,n)=>{const r=kS();if(t.meta.requiresAuth&&(!r.user&&r.loading&&await r.fetchUser(),!r.user))return n({name:"login"});if(t.meta?.title&&(document.title=t.meta.title),t.meta?.icon){const s=document.querySelector("link[rel~='icon']")||document.createElement("link");s.rel="icon",s.href=t.meta.icon,document.head.appendChild(s)}n()});var VS="firebase",xS="12.7.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
