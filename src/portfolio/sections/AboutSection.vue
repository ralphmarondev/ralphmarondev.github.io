						...
						<div class="grid grid-cols-1 sm:grid-cols-3 gap-6 aos-init aos-animate" data-aos="fade-right">
							<div class="flex flex-col aos-init aos-animate" data-aos="fade-right" data-aos-delay="0">
								<div class="flex items-center space-x-3 mb-2">
									<div class="p-4 bg-purple-500 rounded-full shadow-lg flex items-center justify-center text-white">
							...
							<div class="flex flex-col aos-init aos-animate" data-aos="fade-right" data-aos-delay="0">
								<div class="flex items-center space-x-3 mb-2">
									<div class="p-4 bg-pink-500 rounded-full shadow-lg flex items-center justify-center text-white">
							...
							<div class="flex flex-col aos-init aos-animate" data-aos="fade-right" data-aos-delay="0">
								<div class="flex items-center space-x-3 mb-2">
									<div class="p-4 bg-orange-500 rounded-full shadow-lg flex items-center justify-center text-white">
							...
							<div class="flex flex-col aos-init aos-animate" data-aos="fade-right" data-aos-delay="0">
								<div class="flex items-center space-x-3 mb-2">
									<div class="p-4 bg-blue-500 rounded-full shadow-lg flex items-center justify-center text-white">
							...
							<div class="flex flex-col aos-init aos-animate" data-aos="fade-right" data-aos-delay="0">
								<div class="flex items-center space-x-3 mb-2">
									<div class="p-4 bg-red-500 rounded-full shadow-lg flex items-center justify-center text-white">
							...
							<div class="flex flex-col aos-init aos-animate" data-aos="fade-right" data-aos-delay="0">
								<div class="flex items-center space-x-3 mb-2">
									<div class="p-4 bg-teal-500 rounded-full shadow-lg flex items-center justify-center text-white">
